...
const val FULL_MEALS_TABLE_NAME = "full_meals"

@Entity(tableName = FULL_MEALS_TABLE_NAME)
data class FullMealEntityModel(
...
fun FullMealEntityModel.toFullMealDomainModel(): FullMealDomainModel = FullMealDomainModel(
...
fun FullMealDomainModel.toFullMealEntityModel(): FullMealEntityModel {
    return FullMealEntityModel(
        idMeal = this.idMeal,
        dateModified = this.dateModified as? String,
        strArea = this.strArea,
        strCategory = this.strCategory,
        strCreativeCommonsConfirmed = this.strCreativeCommonsConfirmed as? String,
        strDrinkAlternate = this.strDrinkAlternate as? String,
        strImageSource = this.strImageSource as? String,
        strInstructions = this.strInstructions,
        strMeal = this.strMeal,
        strMealThumb = this.strMealThumb,
        strSource = this.strSource,
